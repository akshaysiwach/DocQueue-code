  ...
  return (
    <div className="md:mx-10">
      <div className="flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10  mt-40 text-sm">
        <div>
          <img className="mb-5 w-40" src={assets.logog} alt="" />
          <p className="w-full md:w-2/3 text-gray-600 leading-6">
            At DocQueue, we connect you with highly qualified and experienced
            ...
            ongoing care, DocQueue ensures you have access to the best medical
      ...
      <div>
        ...
        <p className="py-5 text-sm text-center">
          Copyright 2025 @ DocQueue.com - All Right Reserved.
        </p>
      </div>
    </div>
  );
